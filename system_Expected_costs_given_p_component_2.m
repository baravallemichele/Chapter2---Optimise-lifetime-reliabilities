function [ Expected_costs_over_different_systems ] = system_Expected_costs_given_p_component_2( p_component,beta_component,input )
%Calcualte the Expected costs given p_component
%   input
%       p : design parameter
...
Expected_costs=zeros(1,input.N_sim);
    ...
    Expected_costs_over_different_systems=mean(Expected_costs);        
end
