function [ Exp_cost ] = Expectedcosts_given_betacomponent_for_each_stru( beta_component,input,rv,i_sim )
%for a given input.i_sim it gives the Exp_cost associated to a beta_system
...
myfun=@(pp_component) (component_beta_given_p_component( pp_component,input,i_sim ) - beta_component)^2;


[p_component]=fminsearch(myfun,p_start,input.options_fminsearch);

beta_system=system_beta_given_p_component(p_component,input,i_sim);
